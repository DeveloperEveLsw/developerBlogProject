...
class peg$SyntaxError extends SyntaxError {
  ...
  function peg$parse(input, options) {
    ...
    const peg$e0 = peg$literalExpectation(":::nested-array", false);
    ...
    function peg$f0(data, style) {
      return { type:"nestedArrayBlock" ,data, style, children:[] }
    }
    ...
    function peg$f6(from, to) {
      ...
      return Array.from({ length: yEnd - yStart + 1 }, (_, dy) =>
        Array.from({ length: xEnd - xStart + 1 }, (_, dx) =>
          [xStart + dx, yStart + dy]
        )
      ).flat(); // 2D → flat array of [x,y]
    }
    function peg$f7(n) {    return [n];  }
    function peg$f8(x, y) {    return [x,y]  }
    function peg$f9(name, value) {
      return name+": "+value+";";
    }
    function peg$f10(chars) {    return chars.join("");  }
    function peg$f11(chars) {    return chars.join("").trim();  }
